-- 106: Call auto_assign_competition_stages at start of end_season (before HOF loop)
-- Ensures competition stages are derived from match results before HOF points are calculated
