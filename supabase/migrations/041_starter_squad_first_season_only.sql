-- 041: Clarify starter squads are first-season only (OVR 50-60)
-- Starter squads = one-time basis for new teams.
-- New players after that: Packs, Draft (S2+), Free Agents, Auctions, Trades (per final_doc.md).

DROP FUNCTION IF EXISTS get_starter_squad_max_rating(INTEGER);
