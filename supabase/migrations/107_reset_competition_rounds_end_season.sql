-- 107: Reset current_round_ucl, current_round_uel, current_round_uecl to 0 in end_season when transitioning to OFFSEASON
-- Ensures competition round counters start fresh for the new season
...
BEGIN
  ...
  -- Auto-assign competition stages from match results (UCL/UEL/UECL)
  ...
  -- Step 10-11: Increment season + set OFFSEASON + reset competition round counters
  UPDATE leagues SET
    season = season + 1,
