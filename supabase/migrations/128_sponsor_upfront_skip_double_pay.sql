-- 128: Skip sponsor base payment when already paid upfront
-- v_already_paid checks finances for existing 'Sponsor Payment' for team/league/season
-- Wraps fixed payout and performance_tier fallback base payments with IF NOT v_already_paid
