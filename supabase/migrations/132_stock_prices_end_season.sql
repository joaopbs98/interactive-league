-- 132: Recompute team stock values at end of season
-- update_league_stock_prices() (081) was defined but never invoked anywhere,
-- so teams.stock_value never refreshed. Call it from end_season, alongside
-- the comp_index update it depends on.
