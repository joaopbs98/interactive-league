-- 097: Extend sponsor bonus evaluation for position<=6 and competition objectives (UCL/UEL/UECL)
-- team_competition_results.stage stores values like "UCL Winners", "UEL Group Stage"
...
-- Update end_season sponsor bonus block to use eval_sponsor_bonus (adds position<=6, UCL/UEL/UECL)
-- We replace the IF/ELSIF block with a single call to eval_sponsor_bonus
...
BEGIN
  ...
  -- Step 9: CompIndex = top 14 OVR average
