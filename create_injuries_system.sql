...
INSERT INTO injuries (player_id, team_id, type, description, games_remaining) VALUES
-- Sample injuries (replace with actual player_ids and team_ids from your database)
('player1', (SELECT id FROM teams LIMIT 1), 'injury', 'Hamstring strain', 3),
('player2', (SELECT id FROM teams LIMIT 1), 'suspension', 'Red card - serious foul', 1),
('player3', (SELECT id FROM teams LIMIT 1), 'injury', 'Ankle sprain', 2);

-- Verify the setup
SELECT 
  'Injuries table created successfully' as status,
